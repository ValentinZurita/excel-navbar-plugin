    ...
    plugins: [
      ...
      new CopyWebpackPlugin({
        patterns: [
          ...
          { from: 'src/landing/legal.css', to: 'legal.css' },
          { from: 'src/landing/privacy.html', to: 'privacy.html' },
          { from: 'src/landing/terms.html', to: 'terms.html' },
          { from: 'src/landing/support.html', to: 'support.html' },
